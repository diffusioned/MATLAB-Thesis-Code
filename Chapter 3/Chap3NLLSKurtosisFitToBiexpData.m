% Chap3NLLSKurtosisFitToBiexpData.m
% MATLAB file for plotting data in PhD thesis by Ned Charles available here http://hdl.handle.net/2123/16060
function Chap3NLLSKurtosisFitToBiexpData()

load('YourPath\NoisyBiexpSignalsSNR200.mat'); % HPC Scratch
...
TrueSTDNoise = 0.005 % For SNR of 25 = 0.04
...
save('YourPath\KurtFitArray.mat','KurtFitArray','-v7.3');
save('YourPath\KurtResidualArray.mat','KurtResidualArray','-v7.3');
save('YourPath\KurtFitJacobianArray.mat','KurtFitJacobianArray','-v7.3');
save('YourPath\KurtFitOutputFlagArray.mat','KurtFitOutputFlagArray','-v7.3');
